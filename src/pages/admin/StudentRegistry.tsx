    ...
    <Layout role="admin">
      <div className="max-w-[1440px] mx-auto px-margin_mobile md:px-margin_desktop py-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="font-display-lg text-display-lg text-primary">Student Registry</h2>
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="bg-primary text-on-primary">
                ...
                <th className="py-3 px-6 font-data-table text-data-table uppercase tracking-wider">Gender</th>
